...
//         :openbottomsheet === "Addtask" ? 
      ...
      <View >
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 1. Lawn and Entrance Area is clean. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 2: Pool cleaned. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 3 . All AC in Working Condition. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 4.  Muisc System Working. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 5. First aid box. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 6. Dry bathroom floors NOT WET. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 7. Toiletries and Replenishments (tissue/toilet paper etc.)  </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 8. Proper Water Pressure & all Geyser in Working Condition. </Text>
        ...
        <SwitchToggle
          ...
          duration={100}
        />
          <Text style={{fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:18,color:"#000000",paddingLeft:40,textAlign:"left"}} > 9. Clean Kitchen & Gas Cylinder. </Text>
      ...
      const renderItem = ({ item }) => (
        ...
        <TouchableOpacity  onPress={() => {
          ...
          sheetRef.current.snapTo(0)}} style={styles.item}>
            ...
            <Text style={{fontSize:14,fontWeight:"400",lineHeight:21,fontFamily:"Poppins-Regular",color:"#9b9b9b",alignSelf:"flex-end",marginTop:20}} >{item.place}</Text>
...
<Text style={{paddingLeft:20,fontFamily:"Poppins-Regular",fontWeight:"400",fontSize:14,color:"#000000"}}>Date:  {currentDate}</Text>
