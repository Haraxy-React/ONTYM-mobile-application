...
export const DynamicAddAdvancePayment = (props, { objUpdate }) => {
    ...
    // console.log("MEMO: ", props.objUpdate);

    useMemo(() => {
        console.log("MEMO: ", props.objUpdate.add_advance_Payment);
        if (typeof props.objUpdate.add_advance_Payment !== "undefined") {

            setCountTime(props.objUpdate.add_advance_Payment)
            console.log("COUNTERTIME:  ", countTime);
        }
    }, [props.objUpdate.add_advance_Payment]);
    ...
    const removeData = (i) => {
        ...
        props.setAdvancePaymentList({ name: "add_advance_Payment", value: [...newFormValues] })
    ...
    const handleChange = (i, val, name) => {
        ...
        props.setAdvancePaymentList({ name: "add_advance_Payment", value: [...countTime] })
    ...
    return (
        <View>
            <TouchableOpacity
                ...
                <Text style={{ fontSize: 18, fontFamily: "Poppins-Regular", lineHeight: 27, color: "#2D9cDB", marginTop: 3, marginLeft: 10 }}>Add Advance Payment</Text>
            </TouchableOpacity>
            {
